...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
          <div class="blog-post-single">
            <img
              ...
              src="assets/images/resource/blog-single.jpg"
              alt=""
            />
            <div class="post-info">
              <h3>
            ...
            <div class="row bb-info">
              <div class="col-lg-6 col-md-6 col-sm-6">
                <img
                  src="assets/images/resource/blog-single2.jpg"
                  alt=""
                  class="mw-100"
                />
                <p>
              ...
              <div class="col-lg-6 col-md-6 col-sm-6">
                <img src="assets/images/resource/single3.jpg" alt="" class="mw-100" />
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. In
                  luctus leo sit amet lorem egestas iaculis. Donec nibh enim,
                  pharetra vel turpis non, vulputate luctus ex. Phasellus
            ...
            <img
              ...
              src="assets/images/resource/single4.jpg"
              alt=""
            />
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam
          ...
          <div class="swiper-container swiper2 blog-posts">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="post">
                  <div class="post-thumb">
                    <img src="assets/images/resource/rp1.jpg" alt="" />
                  </div>
                  <div class="post-info">
                    <h3>
              ...
              <div class="swiper-slide">
                <div class="post">
                  <div class="post-thumb">
                    <img src="assets/images/resource/rp2.jpg" alt="" />
                  </div>
                  <div class="post-info">
                    <h3>
                      <a href="blog-single.php" title=""
              ...
              <div class="swiper-slide">
                <div class="post">
                  <div class="post-thumb">
                    <img src="assets/images/resource/rp3.jpg" alt="" />
                  </div>
                  <div class="post-info">
                    <h3>
                      <a href="blog-single.php" title=""
              ...
              <div class="swiper-slide">
                <div class="post">
                  <div class="post-thumb">
                    <img src="assets/images/resource/rp5.jpg" alt="" />
                  </div>
                  <div class="post-info">
                    <h3>
                      <a href="blog-single.php" title=""
              ...
              <div class="swiper-slide">
                <div class="post">
                  <div class="post-thumb">
                    <img src="assets/images/resource/rp4.jpg" alt="" />
                  </div>
                  <div class="post-info">
                    <h3>
                      <a href="blog-single.php" title=""
    ...
    <script>
      (function () {
        var js =
          "window['__CF$cv$params']={r:'865490096a0e3cb3',t:'MTcxMDU5MDIxNC43MzIwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='cdn-cgi/challenge-platform/h/b/scripts/jsd/ace796eb5511/main.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";
