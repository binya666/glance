<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from uena.dexignzone.com/django/xhtml/chart-chartjs.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:20:33 GMT -->
  <head>
    <!-- Title -->
          ...
          <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
              <div class="header-left">
                <div class="dashboard_bar">ChartJS</div>
              </div>
                    ...
                    <div class="card-body">
                      <div class="chart-point">
                        ...
                        <ul class="chart-point-list">
                          <li>
                            <i class="fa fa-circle text-primary me-1"></i> 40%
                            Tickets
                          </li>
                          <li>
                            <i class="fa fa-circle text-success me-1"></i> 35%
                            Events
                          </li>
                          <li>
                            <i class="fa fa-circle text-warning me-1"></i> 25%
                            Other
                          </li>
                        </ul>
                      </div>
  ...
  <!-- Mirrored from uena.dexignzone.com/django/xhtml/chart-chartjs.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:20:39 GMT -->
</html>
