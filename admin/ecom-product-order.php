<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from uena.dexignzone.com/django/xhtml/ecom-product-order.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:19:59 GMT -->
  <head>
    <!-- Title -->
          ...
          <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
              <div class="header-left">
                <div class="dashboard_bar">Product Order</div>
              </div>
      ...
      <div class="deznav">
        <div class="deznav-scroll">
          <ul class="metismenu" id="menu">
            ...
            <li>
              <a href="widget-basic.php" class="ai-icon" aria-expanded="false">
            ...
            <li>
              ...
              <ul aria-expanded="false">
                ...
                <li>
                  <a href="form-validation-jquery.php">Jquery Validate</a>
                </li>
              </ul>
            </li>
            <li>
          ...
          <div class="copyright">
            <p>
              <strong>Uena Admin Dashboard</strong> © 2024 All Rights Reserved
            </p>
            <p class="fs-12">
            ...
            >
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                  <a href="javascript:void(0)">Product Order</a>
                </li>
              </ol>
            </div>
          </div>
                    ...
                    <table class="table table-sm mb-0">
                      <thead>
                        <tr>
                          ...
                          <th class="align-middle" style="min-width: 12.5rem">
                            Ship to
                          </th>
                      ...
                      <tbody id="orders">
                        <tr class="btn-reveal-trigger">
                          <td class="py-2">
                            <div
                              class="form-check custom-checkbox checkbox-success"
                            >
                              <input
                                type="checkbox"
                                class="form-check-input"
                          ...
                          <td class="py-2">
                            <a href="javascript:void(0);">
                              <strong class="text-primary">#181</strong></a
                            >
                            by <strong class="text-primary">Ricky Antony</strong
                            ><br /><a href="mailto:ricky@example.com"
                              >ricky@example.com</a
                            >
                          </td>
                        ...
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="py-2">
                            <a href="javascript:void(0);">
                              <strong class="text-primary">#182</strong></a
                            >
                            by <strong class="text-primary">Kin Rossow</strong
                            ><br /><a href="mailto:kin@example.com"
                              >kin@example.com</a
                            >
                          </td>
                          <td class="py-2">20/04/2020</td>
                        ...
                        <tr class="btn-reveal-trigger">
                          <td class="py-2">
                            <div
                              class="form-check custom-checkbox checkbox-secondary"
                            >
                              <input
                                type="checkbox"
                                class="form-check-input"
                          ...
                          <td class="py-2">
                            <a href="javascript:void(0);">
                              <strong class="text-primary">#183</strong></a
                            >
                            by <strong class="text-primary">Merry Diana</strong
                            ><br /><a href="mailto:merry@example.com"
                              >merry@example.com</a
                            >
                          </td>
                        ...
                        <tr class="btn-reveal-trigger">
                          <td class="py-2">
                            <div
                              class="form-check custom-checkbox checkbox-warning"
                            >
                              <input
                                type="checkbox"
                                class="form-check-input"
                          ...
                          <td class="py-2">
                            <a href="javascript:void(0);">
                              <strong class="text-primary">#184</strong></a
                            >
                            by <strong class="text-primary">Bucky Robert</strong
                            ><br /><a href="mailto:bucky@example.com"
                              >bucky@example.com</a
                            >
                          </td>
                          <td class="py-2">30/04/2020</td>
                        ...
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="py-2">
                            <a href="javascript:void(0);">
                              <strong class="text-primary">#185</strong></a
                            >
                            by <strong class="text-primary">Rocky Zampa</strong
                            ><br /><a href="mailto:rocky@example.com"
                              >rocky@example.com</a
                            >
                          </td>
                          <td class="py-2">30/04/2020</td>
                        ...
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="py-2">
                            <a href="javascript:void(0);">
                              <strong class="text-primary">#186</strong></a
                            >
                            by <strong class="text-primary">Ricky John</strong
                            ><br /><a href="mailto:ricky@example.com"
                              >ricky@example.com</a
                            >
                          </td>
                          <td class="py-2">30/04/2020</td>
                          <td class="py-2">
                            Ricky John, 1 Infinite Loop, Cupertino, California
                            90210
                            <p class="mb-0 text-500">Via Free Shipping</p>
                          </td>
                          <td class="py-2 text-end">
                        ...
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="py-2">
                            <a href="javascript:void(0);">
                              <strong class="text-primary">#187</strong></a
                            >
                            by
                            <strong class="text-primary"
                              >Cristofer Henric</strong
                            ><br /><a href="mailto:cristofer@example.com"
                              >cristofer@example.com</a
                            >
                          </td>
                          <td class="py-2">30/04/2020</td>
                          <td class="py-2">
                            Cristofer Henric, 1 Infinite Loop, Cupertino,
                            California 90210
                            <p class="mb-0 text-500">Via Flat Rate</p>
                          </td>
                          <td class="py-2 text-end">
                        ...
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="py-2">
                            <a href="javascript:void(0);">
                              <strong class="text-primary">#188</strong></a
                            >
                            by <strong class="text-primary">Brate Lee</strong
                            ><br /><a href="mailto:lee@example.com"
                              >lee@example.com</a
                            >
                          </td>
                          <td class="py-2">29/04/2020</td>
                          <td class="py-2">
                            Brate Lee, 1 Infinite Loop, Cupertino, California
                            90210
                            <p class="mb-0 text-500">Via Link Road</p>
                          </td>
                          <td class="py-2 text-end">
                        ...
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="py-2">
                            <a href="javascript:void(0);">
                              <strong class="text-primary">#189</strong></a
                            >
                            by
                            <strong class="text-primary"
                              >Thomas Stephenson</strong
                            ><br /><a href="mailto:Stephenson@example.com"
                              >Stephenson@example.com</a
                            >
                          </td>
                          <td class="py-2">29/04/2020</td>
                          <td class="py-2">
                        ...
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="py-2">
                            <a href="javascript:void(0);">
                              <strong class="text-primary">#190</strong></a
                            >
                            by <strong class="text-primary">Evie Singh</strong
                            ><br /><a href="mailto:eviewsing@example.com"
                              >eviewsing@example.com</a
                            >
                          </td>
                          <td class="py-2">29/04/2020</td>
                          <td class="py-2">
                        ...
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="py-2">
                            <a href="javascript:void(0);">
                              <strong class="text-primary">#191</strong></a
                            >
                            by <strong class="text-primary">David Peters</strong
                            ><br /><a href="mailto:peter@example.com"
                              >peter@example.com</a
                            >
                          </td>
                          <td class="py-2">29/04/2020</td>
                        ...
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="py-2">
                            <a href="javascript:void(0);">
                              <strong class="text-primary">#192</strong></a
                            >
                            by
                            <strong class="text-primary"
                              >Jennifer Johnson</strong
                            ><br /><a href="mailto:jennifer@example.com"
                              >jennifer@example.com</a
                            >
                          </td>
