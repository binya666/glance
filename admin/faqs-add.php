                ...
                <div class="modal fade" id="addContactModal">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <form method="post" action="scripts/add-faqs.php" enctype="multipart/form-data">
												<div class="mb-3">
													<label class="form-label text-black">FAQS Title</label>
                ...
                <table
                  ...
                  <thead>
                    <tr class="bg-primary">
                      ...
                      <th>
                        <strong class="font-w600 wspace-no">Title</strong>
                      </th>
                      <th>
                        <strong class="font-w600 wspace-no">Description</strong>
                      </th>
                    </tr>
                  </thead>
                  <tbody>
