<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from uena.dexignzone.com/django/xhtml/app-calender.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:19:16 GMT -->
  <head>
    <!-- Title -->
          ...
          <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
              <div class="header-left">
                <div class="dashboard_bar">App Calendar</div>
              </div>
                ...
                <div class="card-body">
                  ...
                  <div class="">
                    <div id="external-events" class="my-3">
                      ...
                      <div
                        class="external-event btn-primary light"
                        data-class="bg-primary"
                      >
                        <i class="fa fa-move"></i><span>New Theme Release</span>
                      </div>
                      <div
                        class="external-event btn-warning light"
                        data-class="bg-warning"
                      >
                        <i class="fa fa-move"></i>My Event
                      </div>
                      <div
                        class="external-event btn-danger light"
                        data-class="bg-danger"
                      >
                        <i class="fa fa-move"></i>Meet manager
                      </div>
                      <div
                        class="external-event btn-info light"
                        data-class="bg-info"
                      >
                        <i class="fa fa-move"></i>Create New theme
                      </div>
                      <div
                        class="external-event btn-dark light"
                        data-class="bg-dark"
                      >
                        <i class="fa fa-move"></i>Project Launch
                      </div>
                      <div
                        class="external-event btn-secondary light"
                    ...
                    <!-- checkbox -->
                    <div
                      class="checkbox form-check checkbox-event custom-checkbox pt-3 pb-5"
                    >
                      <input
                        type="checkbox"
  ...
  <!-- Mirrored from uena.dexignzone.com/django/xhtml/app-calender.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:19:20 GMT -->
</html>
