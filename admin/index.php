                      ...
                      <div class="dz-scroll height500 px-4" id="tredingMenus">
                        ...
                        >
                          ...
                          <div class="me-auto pe-3">
                            ...
                            >
                            <span
                              class="text-black font-w600 d-inline-block me-3"
                              >$5.6
                            </span>
                  ...
                  <div class="card">
                    <div class="card-header media border-0 pb-0">
                      <div class="media-body d-flex">
                        ...
                        <div>
                          <h2 class="text-black fs-32 font-w600 mb-0">
                            892
                            <span class="text-success fs-18 font-w500"
                              >+2,7%</span
                            >
                          </h2>
                    ...
                    <div class="card-header media border-0 pb-0">
                      <div class="media-body d-flex">
                        ...
                        <div>
                          <h2 class="text-black fs-32 font-w600 mb-0">
                            9,334
                            <span class="text-danger fs-18 font-w500"
                              >-0,5%</span
                            >
                          </h2>
                    ...
                    <div class="card-header pb-0 flex-wrap border-0">
                      ...
                      <div class="d-flex mb-3">
                        ...
                        >
                          ...
                          />
                          <label
                            class="form-check-label fs-14 text-black"
                            for="customSwitch11"
                            >Number</label
                          >
                        </div>
                    ...
                    <div class="card-body p-0">
                      <div class="table-responsive">
                              ...
                              <td>
                                <div class="media align-items-center">
                                  <img
                                    class="me-3"
                                    width="87"
                                    src="images/card/Untitled-1.jpg"
                                    alt="DexignZone"
                                  />
                                  <div class="media-body">
                                    <h5 class="mt-0 mb-2">
                                      <a
                                        ...
                                        >Sweet Cheezy Pizza for Kids Meal (Small
                                        Size)</a
                                      >
                                    </h5>
                              ...
                              <td>
                                <div class="media align-items-center">
                                  <img
                                    class="me-3"
                                    width="87"
                                    src="images/card/Untitled-2.jpg"
                                    alt="DexignZone"
                                  />
                                  <div class="media-body">
                                    <h5 class="mt-0 mb-2">
                              ...
                              <td>
                                <div class="media align-items-center">
                                  <img
                                    class="me-3"
                                    width="87"
                                    src="images/card/Untitled-3.jpg"
                                    alt="DexignZone"
                                  />
                                  <div class="media-body">
                                    <h5 class="mt-0 mb-2">
                                      <a
                                        class="text-black"
                                        href="ecom-product-detail.php"
                                        >Extreme Deluxe Pizza Mozarella with
                                        Garlic</a
                                      >
                                    </h5>
                                    <p class="mb-0 text-primary">#0010235</p>
                        ...
                        <div class="card-footer border-0 pt-0 text-center">
                          <a
                            href="javascript:void(0);"
                            class="btn btn-outline-primary dz-load-more"
                            id="orderRequest"
                            rel="ajax/order-request.php"
                            >View More</a
                          >
                        </div>
                      </div>
