...
<!-- Mirrored from uena.dexignzone.com/django/xhtml/ui-button.phpTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:21:00 GMT -->
<head>
    <!-- Title -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-pinterest">Pinterest <span
                                        class="btn-icon-end"><i class="fa-brands fa-square-pinterest"></i></span>
                                </button>
                                <button type="button" class="btn btn-linkedin">Linkedin <span class="btn-icon-end"><i class="fa-brands fa-linkedin-in"></i></span>
                                </button>
                                ...
                                <button type="button" class="btn btn-dribbble">Dribbble <span class="btn-icon-end"><i class="fa-brands fa-dribbble"></i></span>
                                </button>
