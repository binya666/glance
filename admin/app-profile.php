<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from uena.dexignzone.com/django/xhtml/app-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:18:38 GMT -->
  <head>
    <!-- Title -->
    ...
    />
    <link
      href="vendor/lightgallery/dist/css/lightgallery.css"
      rel="stylesheet"
    />
    <link
      href="vendor/lightgallery/dist/css/lg-thumbnail.css"
      rel="stylesheet"
    />
          ...
          <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
              <div class="header-left">
                <div class="dashboard_bar">App Profile</div>
              </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="profile-blog">
                        ...
                        />
                        <h4>
                          <a href="post-details.php" class="text-black"
                            >Darwin's Special Pizza Place</a
                          >
                        </h4>
                        <p class="mb-0">
                        ...
                        <div id="my-posts" class="tab-pane fade active show">
                          <div class="my-post-content pt-3">
                            ...
                            >
                              ...
                              <a class="post-title" href="post-details.php"
                                ><h3 class="text-black">
                                  Double Cheese Dacker Special Pizza
                                </h3></a
                              >
                              <p>
                                A wonderful serenity has take possession of my
                            ...
                            <div class="profile-uoloaded-post pb-3">
                              ...
                              <a class="post-title" href="post-details.php"
                                ><h3 class="text-black">
                                  Are You Looking For,the best Pizza Place?
                                </h3></a
                              >
                              <p>
                                A wonderful serenity has take possession of my
...
Message</textarea
  ...
  <!-- Mirrored from uena.dexignzone.com/django/xhtml/app-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:18:39 GMT -->
</html>
