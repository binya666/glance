...
<!-- Mirrored from uena.dexignzone.com/django/xhtml/form-validation-jquery.phpby HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:23:11 GMT -->
<head>
    <!-- Title -->
                                ...
                                <div class="form-validation">
                                    <form class="needs-validation" novalidate action="#" method="post">
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label form-label" for="validationCustom01">Username
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label form-label" for="validationCustom02">Email <span
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label form-label" for="validationCustom03">Password
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label form-label" for="validationCustom04">Suggestions <span
                                                            class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label form-label" for="validationCustom05">Best Skill
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label form-label" for="validationCustom06">Currency
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label form-label" for="validationCustom07">Website
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label form-label" for="validationCustom08">Phone (US)
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label form-label" for="validationCustom09">Digits <span
                                                            class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label form-label" for="validationCustom10">Number <span
                                                            class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label form-label" for="validationCustom11">Range [1, 5]
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form class="form-valide-with-icon needs-validation" novalidate>
                                        ...
                                        <div class="mb-3">
                                            <label class=" form-label" for="dz-password">Password <span class="text-danger">*</span></label>
...
<!-- Mirrored from uena.dexignzone.com/django/xhtml/form-validation-jquery.phpby HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:23:12 GMT -->
</html>