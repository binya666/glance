...
<!-- Mirrored from uena.dexignzone.com/django/xhtml/svg-icons.phpTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:22:31 GMT -->
<head>
	<!-- Title -->
							...
							<div class="col-xl-2 col-lg-4 col-xxl-3 col-md-6 col-sm-6 col-12 m-b30">
								<div class="svg-icons-ov">
									<div class="svg-icons-prev">
										<svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M14 1.16663C11.6793 1.16663 9.45374 2.0885 7.8128 3.72944C6.17186 5.37039 5.24999 7.59598 5.24999 9.91663V16.7416L3.31332 19.6583C3.08119 20.0162 2.94953 20.4299 2.9321 20.8562C2.91468 21.2824 3.01213 21.7055 3.21427 22.0811C3.41641 22.4568 3.71581 22.7712 4.08112 22.9915C4.44644 23.2118 4.86424 23.3298 5.29082 23.3333H22.7091C23.1385 23.3319 23.5594 23.2143 23.9274 22.9932C24.2954 22.772 24.5967 22.4554 24.7993 22.0769C25.002 21.6984 25.0986 21.2722 25.0787 20.8433C25.0589 20.4145 24.9234 19.9989 24.6866 19.6408L22.75 16.7416V9.91663C22.75 7.59598 21.8281 5.37039 20.1872 3.72944C18.5462 2.0885 16.3206 1.16663 14 1.16663Z" fill="#636363"></path>
										<path d="M14 26.8333C14.7231 26.8325 15.4282 26.6077 16.0184 26.1899C16.6085 25.772 17.0548 25.1817 17.2958 24.4999H10.7042C10.9452 25.1817 11.3915 25.772 11.9816 26.1899C12.5718 26.6077 13.2769 26.8325 14 26.8333Z" fill="#636363"></path>
										</svg>
									</div>
...
&lt;/svg&gt;</pre>
							...
							<div class="col-xl-2 col-lg-4 col-xxl-3 col-md-6 col-sm-6 col-12 m-b30">	
								<div class="svg-icons-ov">
									<div class="svg-icons-prev">
										<svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M22.9166 0.166626H3.08332C2.30977 0.166626 1.56791 0.473917 1.02093 1.0209C0.473947 1.56788 0.166656 2.30974 0.166656 3.08329V18.25C0.166656 19.0235 0.473947 19.7654 1.02093 20.3124C1.56791 20.8593 2.30977 21.1666 3.08332 21.1666H4.24999V25.25C4.25 25.3512 4.27637 25.4507 4.32648 25.5386C4.3766 25.6266 4.44874 25.7 4.53582 25.7516C4.6245 25.8028 4.72509 25.8298 4.82749 25.8298C4.92988 25.8298 5.03048 25.8028 5.11915 25.7516L13.7291 21.1666H22.9166C23.6902 21.1666 24.4321 20.8593 24.979 20.3124C25.526 19.7654 25.8333 19.0235 25.8333 18.25V3.08329C25.8333 2.30974 25.526 1.56788 24.979 1.0209C24.4321 0.473917 23.6902 0.166626 22.9166 0.166626ZM21.75 15.3333H4.24999C4.09528 15.3333 3.9469 15.2718 3.83751 15.1624C3.72811 15.053 3.66665 14.9047 3.66665 14.75C3.66665 14.5952 3.72811 14.4469 3.83751 14.3375C3.9469 14.2281 4.09528 14.1666 4.24999 14.1666H21.75C21.9047 14.1666 22.0531 14.2281 22.1625 14.3375C22.2719 14.4469 22.3333 14.5952 22.3333 14.75C22.3333 14.9047 22.2719 15.053 22.1625 15.1624C22.0531 15.2718 21.9047 15.3333 21.75 15.3333ZM21.75 11.25H4.24999C4.09528 11.25 3.9469 11.1885 3.83751 11.0791C3.72811 10.9697 3.66665 10.8213 3.66665 10.6666C3.66665 10.5119 3.72811 10.3635 3.83751 10.2541C3.9469 10.1447 4.09528 10.0833 4.24999 10.0833H21.75C21.9047 10.0833 22.0531 10.1447 22.1625 10.2541C22.2719 10.3635 22.3333 10.5119 22.3333 10.6666C22.3333 10.8213 22.2719 10.9697 22.1625 11.0791C22.0531 11.1885 21.9047 11.25 21.75 11.25ZM21.75 7.16663H4.24999C4.09528 7.16663 3.9469 7.10517 3.83751 6.99577C3.72811 6.88637 3.66665 6.738 3.66665 6.58329C3.66665 6.42858 3.72811 6.28021 3.83751 6.17081C3.9469 6.06142 4.09528 5.99996 4.24999 5.99996H21.75C21.9047 5.99996 22.0531 6.06142 22.1625 6.17081C22.2719 6.28021 22.3333 6.42858 22.3333 6.58329C22.3333 6.738 22.2719 6.88637 22.1625 6.99577C22.0531 7.10517 21.9047 7.16663 21.75 7.16663Z" fill="#636363"></path>
										</svg>
									</div>
...
&lt;/svg&gt;
							...
							<div class="col-xl-2 col-lg-4 col-xxl-3 col-md-6 col-sm-6 col-12 m-b30">	
								<div class="svg-icons-ov">
									<div class="svg-icons-prev">
										<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#FF720D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
									</div>
...
&lt;svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#FF720D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"&gt;&lt;path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"&gt;&lt;/path&gt;&lt;polyline points="16 17 21 12 16 7"&gt;&lt;/polyline&gt;&lt;line x1="21" y1="12" x2="9" y2="12"&gt;&lt;/line&gt;&lt;/svg&gt;
							...
							<div class="col-xl-2 col-lg-4 col-xxl-3 col-md-6 col-sm-6 col-12 m-b30">	
								<div class="svg-icons-ov">
									<div class="svg-icons-prev">
										<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#FF720D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
									</div>
...
&lt;svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#FF720D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"&gt;&lt;path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"&gt;&lt;/path&gt;&lt;polyline points="22,6 12,13 2,6"&gt;&lt;/polyline&gt;&lt;/svg&gt;
							...
							<div class="col-xl-2 col-lg-4 col-xxl-3 col-md-6 col-sm-6 col-12 m-b30">	
								<div class="svg-icons-ov">
									<div class="svg-icons-prev">
										<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#FF720D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
									</div>
...
&lt;svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#FF720D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"&gt;&lt;path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"&gt;&lt;/path&gt;&lt;circle cx="12" cy="7" r="4"&gt;&lt;/circle&gt;&lt;/svg&gt;
							...
							<div class="col-xl-2 col-lg-4 col-xxl-3 col-md-6 col-sm-6 col-12 m-b30">	
								<div class="svg-icons-ov">
									...
									<div class="svg-classname">menu.svg</div>
									<div class="svg-icon-popup">
									...
									<div class="modal fade" id="svg_img_Brassieresvg-25" tabindex="-1" role="dialog" aria-labelledby="svg_img_label_Brassieresvg-25">
										<div class="modal-dialog modal-dialog-centered" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="svg_img_label_Brassieresvg-25">menu.svg</h5>
													<button type="button" class="btn-close"  data-bs-dismiss="modal" aria-label="Close">
													</button>
												</div>
												<div class="modal-body">
														<pre>&lt;img src="images/iconly/bulk/menu.svg"/&gt;</pre>
												</div>
												<div class="modal-footer">
													<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
												</div>
									...
									<div class="modal-dialog modal-dialog-centered" role="document">
										<div class="modal-content">
											<div class="modal-header">
												<h5 class="modal-title" id="svg_inline_label_Brassieresvg-25">menu.svg</h5>
												<button type="button" class="btn-close"   data-bs-dismiss="modal" aria-label="Close">
												</button>
											</div>
											<div class="modal-body">
...
&lt;/svg&gt;
							...
							<div class="col-xl-2 col-lg-4 col-xxl-3 col-md-6 col-sm-6 col-12 m-b30">	
								<div class="svg-icons-ov">
									...
									<div class="svg-classname">users.svg</div>
									<div class="svg-icon-popup">
									...
									<div class="modal fade" id="svg_img_Brassieresvg-27" tabindex="-1" role="dialog" aria-labelledby="svg_img_label_Brassieresvg-27">
										<div class="modal-dialog modal-dialog-centered" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="svg_img_label_Brassieresvg-27">users.svg</h5>
													<button type="button" class="btn-close"  data-bs-dismiss="modal" aria-label="Close">
													</button>
												</div>
												<div class="modal-body">
													<pre>&lt;img src="images/iconly/bulk/users.svg"/&gt;</pre>
												</div>
												<div class="modal-footer">
													<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
												</div>
									...
									<div class="modal fade" id="svg_inline_Brassieresvg-27" tabindex="-1" role="dialog" aria-labelledby="svg_inline_label_Brassieresvg-27">
										<div class="modal-dialog modal-dialog-centered" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="svg_inline_label_Brassieresvg-27">users.svg</h5>
													<button type="button" class="btn-close"   data-bs-dismiss="modal" aria-label="Close">
													</button>
												</div>
												<div class="modal-body">
...
&lt;/svg&gt;
							...
							<div class="col-xl-2 col-lg-4 col-xxl-3 col-md-6 col-sm-6 col-12 m-b30">	
								<div class="svg-icons-ov">
									...
									<div class="svg-classname">cross-arrow.svg</div>
									<div class="svg-icon-popup">
									...
									<div class="modal fade" id="svg_img_Brassieresvg-28" tabindex="-1" role="dialog" aria-labelledby="svg_img_label_Brassieresvg-28">
										<div class="modal-dialog modal-dialog-centered" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="svg_img_label_Brassieresvg-28">cross-arrow.svg</h5>
													<button type="button" class="btn-close"  data-bs-dismiss="modal" aria-label="Close">
													</button>
												</div>
												<div class="modal-body">
													<pre>&lt;img src="images/iconly/bulk/cross-arrow.svg"/&gt;</pre>
												</div>
												<div class="modal-footer">
													<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
												</div>
									...
									<div class="modal fade" id="svg_inline_Brassieresvg-28" tabindex="-1" role="dialog" aria-labelledby="svg_inline_label_Brassieresvg-28">
										<div class="modal-dialog modal-dialog-centered" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="svg_inline_label_Brassieresvg-28">cross-arrow.svg</h5>
													<button type="button" class="btn-close"   data-bs-dismiss="modal" aria-label="Close">
													</button>
												</div>
												<div class="modal-body">
								...
								<div class="svg-icons-ov">
									...
									<div class="modal fade" id="svg_img_Brassieresvg-31" tabindex="-1" role="dialog" aria-labelledby="svg_img_label_Brassieresvg-31">
										<div class="modal-dialog modal-dialog-centered" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="svg_img_label_Brassieresvg-31">Call.svg</h5>
													<button type="button" class="btn-close"  data-bs-dismiss="modal" aria-label="Close">
													</button>
												</div>
												<div class="modal-body">
									...
									<div class="modal fade" id="svg_inline_Brassieresvg-31" tabindex="-1" role="dialog" aria-labelledby="svg_inline_label_Brassieresvg-31">
										<div class="modal-dialog modal-dialog-centered" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="svg_inline_label_Brassieresvg-31">Call.svg</h5>
													<button type="button" class="btn-close"   data-bs-dismiss="modal" aria-label="Close">
													</button>
												</div>
												<div class="modal-body">
...
&lt;/svg&gt;
							...
							<div class="col-xl-2 col-lg-4 col-xxl-3 col-md-6 col-sm-6 col-12 m-b30">	
								<div class="svg-icons-ov">
									<div class="svg-icons-prev">
										<svg width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" style="min-width: 24px;">
											<path d="M28 13.3333C28 22.6667 16 30.6667 16 30.6667C16 30.6667 4 22.6667 4 13.3333C4 10.1507 5.26428 7.09848 7.51472 4.84805C9.76516 2.59761 12.8174 1.33333 16 1.33333C19.1826 1.33333 22.2348 2.59761 24.4853 4.84805C26.7357 7.09848 28 10.1507 28 13.3333Z" stroke="#FF720D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
											<path d="M16 17.3333C18.2091 17.3333 20 15.5425 20 13.3333C20 11.1242 18.2091 9.33333 16 9.33333C13.7909 9.33333 12 11.1242 12 13.3333C12 15.5425 13.7909 17.3333 16 17.3333Z" stroke="#FF720D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
										</svg>
									</div>
									...
									<div class="modal fade" id="svg_img_Brassieresvg-32" tabindex="-1" role="dialog" aria-labelledby="svg_img_label_Brassieresvg-32">
										<div class="modal-dialog modal-dialog-centered" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="svg_img_label_Brassieresvg-32">location.svg</h5>
													<button type="button" class="btn-close"  data-bs-dismiss="modal" aria-label="Close">
													</button>
												</div>
												<div class="modal-body">
									...
									<div class="modal fade" id="svg_inline_Brassieresvg-32" tabindex="-1" role="dialog" aria-labelledby="svg_inline_label_Brassieresvg-32">
										<div class="modal-dialog modal-dialog-centered" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="svg_inline_label_Brassieresvg-32">location.svg</h5>
													<button type="button" class="btn-close"   data-bs-dismiss="modal" aria-label="Close">
													</button>
												</div>
												<div class="modal-body">
...
<!-- Mirrored from uena.dexignzone.com/django/xhtml/svg-icons.phpTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:22:32 GMT -->
</html>