				...
				<div class="row">
					<div class="col-xl-12">
						<div class="d-flex flex-wrap mb-3">
							<a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#addContactModal" class="btn btn-outline-primary  me-auto mb-2">Add New Member</a>
							<!-- Add Order -->
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											<form method="post" action="scripts/add-teammember.php" enctype="multipart/form-data">
												<div class="mb-3">
												...
												<div class="mb-3">
													<label class="form-label text-black">file</label>
                        ...
                        ?>
									<tr>
										...
										<td><?php echo $DataRows['designation']; ?></td>
										<td><img src="<?php echo "../uploads/teammembers/".$DataRows['image']; ?>" width='50px' height="50px" alt="image not found"></td>
									</tr>
									<?php
                            }
                        } else {
...
<!-- Mirrored from uena.dexignzone.com/django/xhtml/customer-list.phpy HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:18:56 GMT -->
</html>