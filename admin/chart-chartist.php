<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from uena.dexignzone.com/django/xhtml/chart-chartist.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:20:40 GMT -->
  <head>
    <!-- Title -->
          ...
          <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
              <div class="header-left">
                <div class="dashboard_bar">Chartist</div>
              </div>
            ...
            >
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                  <a href="javascript:void(0)">Chartist</a>
                </li>
              </ol>
            </div>
          </div>
                ...
                <div class="col-xl-6 col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div
                        id="smil-animations"
                        class="ct-chart ct-golden-section chartlist-chart"
                      ></div>
                    </div>
                  </div>
                </div>
  ...
  <!-- Mirrored from uena.dexignzone.com/django/xhtml/chart-chartist.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:20:44 GMT -->
</html>
