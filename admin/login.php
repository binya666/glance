  ...
  <body>
    <div class="authincation d-flex flex-column flex-lg-row flex-column-fluid">
      <div class="login-aside text-center d-flex flex-column flex-row-auto">
        ...
        <div
          class="aside-image"
          style="background-image: url(images/background/pic1.svg)"
        ></div>
      </div>
      <div
              ...
              <div class="col-xl-12 tab-content">
                ...
                >
                  ...
                  <div class="form-group mb-3">
                    <label class="mb-1 form-label text-black">Username</label>
                    <div>
                      <input
                        type="text"
                        class="form-control"
                ...
                <div class="new-account mt-3">
                  <p>
                    ...
                    <a class="text-primary" href="page-register.php">Sign up</a>
                  </p>
                </div>
              </div>
            </div>
...
***********************************-->
  ...
  <!-- Mirrored from uena.dexignzone.com/django/xhtml/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:18:43 GMT -->
</html>
