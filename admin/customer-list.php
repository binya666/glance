<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from uena.dexignzone.com/django/xhtml/customer-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:18:56 GMT -->
  <head>
    <!-- Title -->
            ...
            <div class="col-xl-12">
              <div class="d-flex flex-wrap mb-3">
                <a
                  ...
                  class="btn btn-outline-primary me-auto mb-2"
                  >Add New Customer</a
                >
                <!-- Add Order -->
              ...
              <div class="table-responsive">
                ...
                >
                  <thead>
                    <tr class="bg-primary">
                      <th
                        class="sorting_1 pe-0 text-center bg-none no-data-img"
                      >
                      ...
                      <th>
                        <strong class="font-w600 wspace-no">Customer ID</strong>
                      </th>
                      <th>
                        <strong class="font-w600 wspace-no">Join Date</strong>
                      </th>
                      <th>
                        <strong class="font-w600 wspace-no"
                          >Customer Name</strong
                        >
                      </th>
                      <th>
                        <strong class="font-w600 wspace-no">Location</strong>
                      </th>
                      <th>
                        <strong class="font-w600 wspace-no">Total Spent</strong>
                      </th>
                      <th>
                        <strong class="font-w600 wspace-no">Last Order</strong>
                      </th>
                      <th class="bg-none"></th>
                    </tr>
                  </thead>
