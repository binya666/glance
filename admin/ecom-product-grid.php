...
<!-- Mirrored from uena.dexignzone.com/django/xhtml/ecom-product-grid.phpby HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:19:20 GMT -->
<head>
    <!-- Title -->
                            ...
                            <div class="card-body">
                                <div class="new-arrival-product">
                                    ...
                                    <div class="new-arrival-content text-center mt-3">
                                        <h4><a href="ecom-product-detail.php>Vegies Pizza</a></h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="new-arrival-product">
                                    ...
                                    <div class="new-arrival-content text-center mt-3">
                                        <h4><a href="ecom-product-detail.php>Cheese Pizza</a></h4>
                                        <ul class="star-rating">
                                            <li><i class="fa fa-star"></i></li>
                                            <li><i class="fa fa-star"></i></li>
                                            <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="new-arrival-product">
                                    ...
                                    <div class="new-arrival-content text-center mt-3">
                                        <h4><a href="ecom-product-detail.php>Tomato Pizza</a></h4>
                                        <ul class="star-rating">
                                            <li><i class="fa fa-star"></i></li>
                                            <li><i class="fa fa-star"></i></li>
                                            <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="new-arrival-product">
                                    ...
                                    <div class="new-arrival-content text-center mt-3">
                                        <h4><a href="ecom-product-detail.php>Pasta Pizza</a></h4>
                                        <ul class="star-rating">
                                            <li><i class="fa fa-star"></i></li>
                                            <li><i class="fa fa-star"></i></li>
                                            <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="new-arrival-product">
                                    ...
                                    <div class="new-arrival-content text-center mt-3">
                                        <h4><a href="ecom-product-detail.php>Chilli Pepper Pizza</a></h4>
                                        <ul class="star-rating">
                                            <li><i class="fa fa-star"></i></li>
                                            <li><i class="fa fa-star"></i></li>
                                            <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="new-arrival-product">
                                    ...
                                    <div class="new-arrival-content text-center mt-3">
                                        <h4><a href="ecom-product-detail.php>Cashew Pizza</a></h4>
                                        <ul class="star-rating">
                                            <li><i class="fa fa-star"></i></li>
                                            <li><i class="fa fa-star"></i></li>
                                            <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="new-arrival-product">
                                    ...
                                    <div class="new-arrival-content text-center mt-3">
                                        <h4><a href="ecom-product-detail.php>OTC Pizza</a></h4>
                                        <ul class="star-rating">
                                            <li><i class="fa fa-star"></i></li>
                                            <li><i class="fa fa-star"></i></li>
                                            <li><i class="fa fa-star"></i></li>
...
<!-- Mirrored from uena.dexignzone.com/django/xhtml/ecom-product-grid.phpby HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:19:42 GMT -->
</html>