...
<!-- Mirrored from uena.dexignzone.com/django/xhtml/email-inbox.phpTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:18:39 GMT -->
<head>
    <!-- Title -->
								...
								<div class="row">
									<div class="col-xl-3 email-left-body">
										<div class="email-left-box">
											<div class="p-0">
												<a href="email-compose.phps="btn btn-primary btn-block">Compose</a>
											</div>
											<div class="mail-list mt-4">
												<a href="email-inbox.phps="list-group-item active"><i
											...
											<div class="mail-list mt-4">
												<a href="email-inbox.phps="list-group-item"><span class="icon-warning"><i
															class="fa fa-circle" aria-hidden="true"></i></span>
													Work </a>
												<a href="email-inbox.phps="list-group-item"><span class="icon-primary"><i
															class="fa fa-circle" aria-hidden="true"></i></span>
													Private </a>
												<a href="email-inbox.phps="list-group-item"><span class="icon-success"><i
															class="fa fa-circle" aria-hidden="true"></i></span>
													Support </a>
												<a href="email-inbox.phps="list-group-item"><span class="icon-dpink"><i
															class="fa fa-circle" aria-hidden="true"></i></span>
													Social </a>
											</div>
										</div>
										...
										<div class="email-right-box ">
											<div role="toolbar" class="toolbar ms-1 ms-sm-0 ms-xl-1 d-flex align-items-center">
												...
												<div class="btn-group mb-1 mx-2">
													<button aria-expanded="false" data-bs-toggle="dropdown" class="btn btn-primary px-3 light dropdown-toggle" type="button">More <span class="caret"></span> </button>
											...
											<div class="email-list mt-3">
												<div class="message">
													<div>
														...
														<a href="email-read.phps="col-mail col-mail-2">
