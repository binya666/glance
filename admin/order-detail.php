...
<!-- Mirrored from uena.dexignzone.com/django/xhtml/order-detail.phpTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:18:45 GMT -->
<head>
    <!-- Title -->
			...
			<div class="container-fluid">
				<div class="d-flex mb-3 mb-lg-4 align-items-center">
					...
					<div class="d-flex align-items-center">
						<a href="javascript:void(0);" class="btn btn-outline-danger text-nowrap rounded-0 me-3 ">Cancel Order</a>
						<div class="dropdown">
							<div class="btn btn-success dropdown-toggle d-block text-white rounded-0" data-bs-toggle="dropdown">
									...
									<div class="card-body">
										...
										<div class="order-social">
											<ul class="d-flex justify-content-center">
												...
												<li><a href="javascript:void(0);"><i class="las la-map-marker"></i></a></li>
											</ul>
										</div>
									</div>
								</div>
											...
											<table class="table items-table">
												...
												<tbody>
													<tr>
														<td>
															<div class="media">
																<a href="ecom-product-detail.phpg class="me-3 img-fluid rounded" src="images/card/Untitled-6.jpg" alt="DexignZone"></a>
																<div class="media-body">
																	<small class="mt-0 mb-1 font-w500"><a class="text-primary" href="javascript:void(0);">MAIN COURSE</a></small>
																	<h5 class="mt-0 mb-2 mb-sm-3"><a class="text-black" href="ecom-product-detail.phpcken curry special with cucumber</a></h5>
													...
													<tr>
														<td>
															<div class="media">
																<a href="ecom-product-detail.phpg class="me-3 img-fluid rounded" src="images/card/Untitled-4.jpg" alt="DexignZone"></a>
																<div class="media-body">
																	<small class="mt-0 mb-1 font-w500"><a class="text-primary" href="javascript:void(0);">MAIN COURSE</a></small>
																	<h5 class="mt-0 text-black  mb-2 mb-sm-3"><a class="text-black" href="ecom-product-detail.phpermelon juice with ice</a></h5>
																	<div class="star-review d-flex fs-14">
																		<i class="fa fa-star text-orange"></i>
																		<i class="fa fa-star text-orange"></i>
																		<i class="fa fa-star text-orange"></i>
													...
													<tr>
														<td>
															<div class="media">
																<a href="ecom-product-detail.phpg class="me-3 img-fluid rounded" src="images/card/Untitled-5.jpg" alt="DexignZone"></a>
																<div class="media-body">
																	<small class="mt-0 mb-1 font-w500"><a class="text-primary" href="javascript:void(0);">MAIN COURSE</a></small>
																	<h5 class="mt-0 text-black  mb-2 mb-sm-3"><a class="text-black" href="ecom-product-detail.phpliano pizza with garlic</a></h5>
																	<div class="star-review d-flex fs-14">
																		<i class="fa fa-star text-orange"></i>
																		<i class="fa fa-star text-orange"></i>
																		<i class="fa fa-star text-orange"></i>
											...
											<div class="card-body">
												<div class="row">
													<div class="col-6">
														<div class="text-center p-3">
															<div class="d-inline-block position-relative donut-chart-sale mb-2">
																<span class="donut" data-peity='{ "fill": ["rgb(255, 201, 12,1)", "rgba(239, 239, 239, 1)"],   "innerRadius": 42, "radius": 10}'>5/8</span>
													...
													<div class="col-6">
														<div class="text-center p-3">
															<div class="d-inline-block position-relative donut-chart-sale mb-2">
																<span class="donut" data-peity='{ "fill": ["rgb(0,164,174,1)", "rgba(239, 239, 239, 1)"],   "innerRadius": 42, "radius": 10}'>3/8</span>
...
<!-- Mirrored from uena.dexignzone.com/django/xhtml/order-detail.phpTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:18:56 GMT -->
</html>