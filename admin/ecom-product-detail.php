...
<html lang="en">
  ...
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="vendor/star-rating/star-rating-svg.css"
    />
    <link
          ...
          <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
              <div class="header-left">
                <div class="dashboard_bar">Product Details</div>
              </div>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-xl-3 col-lg-6 col-md-12 col-xxl-5">
                      ...
                      <div
                        class="tab-slide-content new-arrival-product mb-4 mb-xl-0"
                      >
                        <!-- Nav tabs -->

                        <ul
                          class="nav nav-tabs slide-item-list mt-3"
                          id="myTab"
                          role="tablist"
                        >
                    ...
                    <!--Tab slider End-->
                    <div
                      class="col-xl-9 col-lg-6 col-md-12 col-xxl-7 col-sm-12"
                    >
                          ...
                          <div class="d-flex align-items-end flex-wrap mt-4">
                            ...
                            <div class="shopping-cart mb-3 me-3">
                              <a
                                ...
                                href="javascript:void(0)"
                                ><i class="fa fa-shopping-basket me-2"></i>Add
                                to cart</a
                              >
                            </div>
                          </div>
