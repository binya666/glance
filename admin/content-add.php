...
<!-- Mirrored from uena.dexignzone.com/django/xhtml/content-add.phpby HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:28:48 GMT -->
<head>
    <!-- Title -->
            ...
            <div class="container-fluid">
				...
				<div class="">
					<div class="row">
						<div class="col-xl-12">
							<div>
								<a href="content.php class="btn btn-primary mb-3">Content List</a>
							...
							<div class="row">
								<div class="col-xl-8">
									...
									<div class="card h-auto">
										<div class="card-body custom-ekeditor pt-4">
											<div id="ckeditor"></div>
										</div>
									</div>
													...
													<div class="avatar-upload d-flex align-items-center">
														<div class=" position-relative ">
															...
															<div class="change-btn d-flex align-items-center flex-wrap">
																...
																<label for="imageUpload" class="btn btn-dark ms-0 form-label">Select Image</label>
															</div>
														</div>		
													</div>
												</div>
...
<!-- Mirrored from uena.dexignzone.com/django/xhtml/content-add.phpby HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:28:50 GMT -->
</html>