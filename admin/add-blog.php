            ...
            <div class="col-xl-12">
              <div class="mb-5">
                <ul class="d-flex align-items-center flex-wrap">
                  <li>
                    <a href="blog.php" class="btn btn-primary">Blog List</a>
                  </li>
                  <li>
                    <a href="blog-category.php" class="btn btn-primary mx-1"
                      >Blog Category</a
                    >
                  </li>
                  <li>
                    <a
                      ...
                      class="btn btn-primary me-1 mt-sm-0 mt-1"
                      >Add Blog Category</a
                    >
                  </li>
                  <li>
                    <a
                      href="javascript:void(0);"
                      class="btn btn-primary open mt-1 mt-md-0"
                      >Screen Option</a
                    >
                  </li>
                </ul>
                ...
                <div class="row">
                  ...
                  <div class="col-xl-3 col-lg-3 col-sm-4">
                    <div class="form-check">
                      ...
                      />
                      <label
                        class="form-check-label mb-0 text-nowrap"
                  ...
                  <div class="filter cm-content-box box-primary">
                    ...
                    <div class="cm-content-body form excerpt">
                      <div class="card-body">
                        ...
                        <button
                          type="button"
                          class="btn btn-primary btn-sm mt-3 mt-sm-0"
                        >
                          Add Custom Field
                        </button>
                        <small class="mt-3 d-block"
                          >Custom fields can be used to extra metadata to a post
                          that you can use in your theme.</small
                        >
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="card-body">
                          ...
                          <div class="input-group mt-3">
                            ...
                            <span class="input-group-text" id="basic-addon1"
                              ><a href="javascript:void(0);">Add New</a></span
                            >
                          </div>
                        </div>
                      </div>
