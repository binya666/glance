...
<!-- Mirrored from uena.dexignzone.com/django/xhtml/chart-peity.phpy HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:21:00 GMT -->
<head>
    <!-- Title -->
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.phpclass="brand-logo">
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="app-profile.phpclass="dropdown-item ai-icon">
                                        <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                        <span class="ms-2">Profile </span>
                                    </a>
                                    <a href="email-inbox.phpclass="dropdown-item ai-icon">
                                        <svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" class="text-success" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                        <span class="ms-2">Inbox </span>
                                    </a>
                                    <a href="login.phpclass="dropdown-item ai-icon">
				...
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="index.phpDashboard Light</a></li>
							<li><a href="index-2.phpDashboard Dark</a></li>
							<li><a href="orders-list.phpOrders list</a></li>
							<li><a href="order-detail.phpOrder Detail</a></li>
							<li><a href="customer-list.phpCustomers</a></li>
							<li><a href="analytics.phpAnalytics</a></li>
							<li><a href="reviews.phpReviews</a></li>	
						</ul>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="app-profile.phpProfile</a></li>
							<li><a href="post-details.phpPost Details</a></li>
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Email</a>
                                <ul aria-expanded="false">
                                    <li><a href="email-compose.phpCompose</a></li>
                                    <li><a href="email-inbox.phpInbox</a></li>
                                    <li><a href="email-read.phpRead</a></li>
                                </ul>
                            </li>
                            <li><a href="app-calender.phpCalendar</a></li>
							<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Shop</a>
                                <ul aria-expanded="false">
                                    <li><a href="ecom-product-grid.phpProduct Grid</a></li>
									<li><a href="ecom-product-list.phpProduct List</a></li>
									<li><a href="ecom-product-detail.phpProduct Details</a></li>
									<li><a href="ecom-product-order.phpOrder</a></li>
									<li><a href="ecom-checkout.phpCheckout</a></li>
									<li><a href="ecom-invoice.phpInvoice</a></li>
									<li><a href="ecom-customers.phpCustomers</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="chart-flot.phpFlot</a></li>
                            <li><a href="chart-morris.phpMorris</a></li>
                            <li><a href="chart-chartjs.phpChartjs</a></li>
                            <li><a href="chart-chartist.phpChartist</a></li>
                            <li><a href="chart-sparkline.phpSparkline</a></li>
                            <li><a href="chart-peity.phpPeity</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="ui-accordion.phpAccordion</a></li>
                            <li><a href="ui-alert.phpAlert</a></li>
                            <li><a href="ui-badge.phpBadge</a></li>
                            <li><a href="ui-button.phpButton</a></li>
                            <li><a href="ui-modal.phpModal</a></li>
                            <li><a href="ui-button-group.phpButton Group</a></li>
                            <li><a href="ui-list-group.phpList Group</a></li>
                            <li><a href="ui-media-object.phpMedia Object</a></li>
                            <li><a href="ui-card.phpCards</a></li>
                            <li><a href="ui-carousel.phpCarousel</a></li>
                            <li><a href="ui-dropdown.phpDropdown</a></li>
                            <li><a href="ui-popover.phpPopover</a></li>
                            <li><a href="ui-progressbar.phpProgressbar</a></li>
                            <li><a href="ui-tab.phpTab</a></li>
                            <li><a href="ui-typography.phpTypography</a></li>
                            <li><a href="ui-pagination.phpPagination</a></li>
                            <li><a href="ui-grid.phpGrid</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="uc-select2.phpSelect 2</a></li>
                            <li><a href="uc-nestable.phpNestedable</a></li>
                            <li><a href="uc-noui-slider.phpNoui Slider</a></li>
                            <li><a href="uc-sweetalert.phpSweet Alert</a></li>
                            <li><a href="uc-toastr.phpToastr</a></li>
                            <li><a href="map-jqvmap.phpJqv Map</a></li>
							<li><a href="uc-lightgallery.phpLight Gallery</a></li>
                        </ul>
                    </li>
                    <li><a href="widget-basic.phpclass="ai-icon" aria-expanded="false">
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="flat-icons.phpFlaticons</a></li>
                            <li><a href="svg-icons.phpSVG Icons</a></li>
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="content.phpContent</a></li>
                            <li><a href="menu.phpMenus</a></li>
                            <li><a href="email-template.phpEmail Template</a></li>
                            <li><a href="blog.phpBlog</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="form-element.phpForm Elements</a></li>
                            <li><a href="form-wizard.phpWizard</a></li>
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Editor</a>
                                <ul aria-expanded="false">
									<li><a href="form-editor-ckeditor.phpCkeditor</a></li>
                                    <li><a href="form-editor-summernote.phpSummernote</a></li>
                                </ul>
                            </li>
                            <li><a href="form-pickers.phpPickers</a></li>
                            <li><a href="form-validation-jquery.phpJquery Validate</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="table-bootstrap-basic.phpBootstrap</a></li>
                            <li><a href="table-datatable-basic.phpDatatable</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="login.phpLogin 1</a></li>
                            <li><a href="page-login.phpLogin 2</a></li>
                            <li><a href="page-register.phpRegister</a></li>
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Error</a>
                                <ul aria-expanded="false">
                                    <li><a href="page-error-400.phpError 400</a></li>
                                    <li><a href="page-error-403.phpError 403</a></li>
                                    <li><a href="page-error-404.phpError 404</a></li>
                                    <li><a href="page-error-500.phpError 500</a></li>
                                    <li><a href="page-error-503.phpError 503</a></li>
                                </ul>
                            </li>
                            <li><a href="page-lock-screen.phpLock Screen</a></li>
                            <li><a href="empty-page.phpEmpty Page</a></li>
                        </ul>
                    </li>
                </ul>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class=" row">
                                            <div class="col-md-2 col-sm-4 col-6">
												<span class="data-attr" data-peity='{ "fill": ["rgb(255, 114, 13)", "rgba(255, 114, 13, .5)"], "innerRadius": 10, "radius": 40 }'>1/7</span>
                                            </div>
                                            <div class="col-md-2 col-sm-4 col-6 mt-3 mt-md-0"><span class="data-attr" data-peity='{ "fill": ["rgb(120, 120, 120)", "rgba(120, 120, 120, .5)"], "innerRadius": 14, "radius": 36 }'>2/7</span>
                                            </div>
                            ...
                            <div class="card-body pb-0">
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 pb-4">
                                        ...
                                        <div class="px-4"><span class="bar" data-peity='{ "fill": ["rgb(255, 114, 13)", "rgba(255, 114, 13, .5)"]}'>6,2,8,4,3,8,1,3,6,5,9,2,8,1,4,8,9,8,2,1</span>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 pb-4">
                                        <h4 class="card-title mb-4">Bar Chart</h4>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
                                        ...
                                        <div class=""><span class="donut" data-peity='{ "fill": ["rgb(255, 114, 13)", "rgba(255, 114, 13, .5)"]}'>5/8</span>
                                        </div>
                                    </div>
                                    <div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
                                        <h4 class="card-title mb-4">Donut 2</h4>
                                        <div class=""><span class="donut" data-peity='{ "fill": ["rgb(120, 120, 120)", "rgba(120, 120, 120, .5)"]}'>250/650</span>
                                        </div>
                                    </div>
                                    <div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
