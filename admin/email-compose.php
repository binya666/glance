...
<!-- Mirrored from uena.dexignzone.com/django/xhtml/email-compose.php HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:19:13 GMT -->
<head>
    <!-- Title -->
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.phplass="brand-logo">
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="app-profile.phplass="dropdown-item ai-icon">
                                        <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                        <span class="ms-2">Profile </span>
                                    </a>
                                    <a href="email-inbox.phplass="dropdown-item ai-icon">
                                        <svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" class="text-success" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                        <span class="ms-2">Inbox </span>
                                    </a>
                                    <a href="login.phplass="dropdown-item ai-icon">
				...
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="index.phpashboard Light</a></li>
							<li><a href="index-2.phpashboard Dark</a></li>
							<li><a href="orders-list.phprders list</a></li>
							<li><a href="order-detail.phprder Detail</a></li>
							<li><a href="customer-list.phpustomers</a></li>
							<li><a href="analytics.phpnalytics</a></li>
							<li><a href="reviews.phpeviews</a></li>	
						</ul>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="app-profile.phprofile</a></li>
							<li><a href="post-details.phpost Details</a></li>
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Email</a>
                                <ul aria-expanded="false">
                                    <li><a href="email-compose.phpompose</a></li>
                                    <li><a href="email-inbox.phpnbox</a></li>
                                    <li><a href="email-read.phpead</a></li>
                                </ul>
                            </li>
                            <li><a href="app-calender.phpalendar</a></li>
							<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Shop</a>
                                <ul aria-expanded="false">
                                    <li><a href="ecom-product-grid.phproduct Grid</a></li>
									<li><a href="ecom-product-list.phproduct List</a></li>
									<li><a href="ecom-product-detail.phproduct Details</a></li>
									<li><a href="ecom-product-order.phprder</a></li>
									<li><a href="ecom-checkout.phpheckout</a></li>
									<li><a href="ecom-invoice.phpnvoice</a></li>
									<li><a href="ecom-customers.phpustomers</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="chart-flot.phplot</a></li>
                            <li><a href="chart-morris.phporris</a></li>
                            <li><a href="chart-chartjs.phphartjs</a></li>
                            <li><a href="chart-chartist.phphartist</a></li>
                            <li><a href="chart-sparkline.phpparkline</a></li>
                            <li><a href="chart-peity.phpeity</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="ui-accordion.phpccordion</a></li>
                            <li><a href="ui-alert.phplert</a></li>
                            <li><a href="ui-badge.phpadge</a></li>
                            <li><a href="ui-button.phputton</a></li>
                            <li><a href="ui-modal.phpodal</a></li>
                            <li><a href="ui-button-group.phputton Group</a></li>
                            <li><a href="ui-list-group.phpist Group</a></li>
                            <li><a href="ui-media-object.phpedia Object</a></li>
                            <li><a href="ui-card.phpards</a></li>
                            <li><a href="ui-carousel.phparousel</a></li>
                            <li><a href="ui-dropdown.phpropdown</a></li>
                            <li><a href="ui-popover.phpopover</a></li>
                            <li><a href="ui-progressbar.phprogressbar</a></li>
                            <li><a href="ui-tab.phpab</a></li>
                            <li><a href="ui-typography.phpypography</a></li>
                            <li><a href="ui-pagination.phpagination</a></li>
                            <li><a href="ui-grid.phprid</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="uc-select2.phpelect 2</a></li>
                            <li><a href="uc-nestable.phpestedable</a></li>
                            <li><a href="uc-noui-slider.phpoui Slider</a></li>
                            <li><a href="uc-sweetalert.phpweet Alert</a></li>
                            <li><a href="uc-toastr.phpoastr</a></li>
                            <li><a href="map-jqvmap.phpqv Map</a></li>
							<li><a href="uc-lightgallery.phpight Gallery</a></li>
                        </ul>
                    </li>
                    <li><a href="widget-basic.phplass="ai-icon" aria-expanded="false">
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="flat-icons.phplaticons</a></li>
                            <li><a href="svg-icons.phpVG Icons</a></li>
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="content.phpontent</a></li>
                            <li><a href="menu.phpenus</a></li>
                            <li><a href="email-template.phpmail Template</a></li>
                            <li><a href="blog.phplog</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="form-element.phporm Elements</a></li>
                            <li><a href="form-wizard.phpizard</a></li>
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Editor</a>
                                <ul aria-expanded="false">
									<li><a href="form-editor-ckeditor.phpkeditor</a></li>
                                    <li><a href="form-editor-summernote.phpummernote</a></li>
                                </ul>
                            </li>
                            <li><a href="form-pickers.phpickers</a></li>
                            <li><a href="form-validation-jquery.phpquery Validate</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="table-bootstrap-basic.phpootstrap</a></li>
                            <li><a href="table-datatable-basic.phpatatable</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="login.phpogin 1</a></li>
                            <li><a href="page-login.phpogin 2</a></li>
                            <li><a href="page-register.phpegister</a></li>
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Error</a>
                                <ul aria-expanded="false">
                                    <li><a href="page-error-400.phprror 400</a></li>
                                    <li><a href="page-error-403.phprror 403</a></li>
                                    <li><a href="page-error-404.phprror 404</a></li>
                                    <li><a href="page-error-500.phprror 500</a></li>
                                    <li><a href="page-error-503.phprror 503</a></li>
                                </ul>
                            </li>
                            <li><a href="page-lock-screen.phpock Screen</a></li>
                            <li><a href="empty-page.phpmpty Page</a></li>
                        </ul>
                    </li>
                </ul>
								...
								<div class="row">
									<div class="col-xl-3 email-left-body">
										<div class="email-left-box">
											<div class="p-0">
												<a href="email-compose.phplass="btn btn-primary btn-block">Compose</a>
											</div>
											<div class="mail-list mt-4">
												<a href="email-inbox.phplass="list-group-item active"><i
											...
											<div class="mail-list mt-4">
												<a href="email-inbox.phplass="list-group-item"><span class="icon-warning"><i
															class="fa fa-circle" aria-hidden="true"></i></span>
													Work </a>
												<a href="email-inbox.phplass="list-group-item"><span class="icon-primary"><i
															class="fa fa-circle" aria-hidden="true"></i></span>
													Private </a>
												<a href="email-inbox.phplass="list-group-item"><span class="icon-success"><i
															class="fa fa-circle" aria-hidden="true"></i></span>
													Support </a>
												<a href="email-inbox.phplass="list-group-item"><span class="icon-dpink"><i
															class="fa fa-circle" aria-hidden="true"></i></span>
													Social </a>
											</div>
										</div>
									...
									<div class="col-xl-9">
										<div class="email-right-box">
											...
											<div class="text-start mt-4 mb-3">
												<button class="btn btn-danger light btn-sl-sm me-2" type="button"><span class="me-2"><i class="fa fa-times" aria-hidden="true"></i></span>Discard</button>
...
<!-- Mirrored from uena.dexignzone.com/django/xhtml/email-compose.php HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 04:19:16 GMT -->
</html>